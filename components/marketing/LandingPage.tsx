...
const SKY_STATUSES = ["Cielobservable", "Conditions optimales", "Nuit claire détectée", "Prêt pour l'observation"];
    ...
    <a href="#" className="logo" aria-label="SkyQuest, retour en haut">
      <span className="logo-mark" aria-hidden="true">
        <svg viewBox="0 0 28 28">
          ...
          <path d="M14 6 L8 18 L22 16 Z" fill="none" stroke="rgba(255,255,255,0.2)" strokeWidth="0.5" />
        </svg>
      </span>
      SkyQuest
    </a>
...
function Reveal({ children, className = "" }: { children: ReactNode; className?: string }) {
  ...
  return (
    <motion.div
      ...
      whileHover={!prefersReducedMotion && className.includes("feature-card") ? { y: -4 } : undefined}
    >
      {children}
    </motion.div>
  );
...
export function LandingPage() {
  ...
  useEffect(() => {
    ...
    const updateNav = () => {
      ...
      nav.style.background = window.scrollY > 40 ? "rgba(10, 10, 11, 0.92)" : "rgba(10, 10, 11, 0.7)";
    };
  ...
  const showInstallInstructions = (event: MouseEvent<HTMLAnchorElement>) => {
    ...
    window.alert("SkyQuest PWA — ajoute cette page à ton écran d'accueil depuis le menu de ton navigateur.");
  };
  ...
  return (
    <main className="marketing-landing">
      ...
      >
        <div className="nav-inner">
          ...
          <div className="nav-links">
            ...
            <a href="#cta" className="nav-cta">Commencer</a>
          </div>
        </div>
      </motion.nav>
      ...
      <header className="hero">
        ...
        <motion.div className="hero-content" variants={heroContainerVariants} initial="hidden" animate="visible">
          <motion.div className="hero-eyebrow" variants={heroItemVariants}><span className="dot" />Ciel actuel · Conseils simples</motion.div>
      ...
      <motion.div className="stats-bar" initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.4 }} variants={heroContainerVariants}>
        <motion.div className="stat" variants={heroItemVariants}><div className="stat-num">88</div><div className="stat-label">Constellations</div></motion.div>
        <motion.div className="stat" variants={heroItemVariants}><div className="stat-num">0</div><div className="stat-label">Télémétrie</div></motion.div>
        <motion.div className="stat" variants={heroItemVariants}><div className="stat-num">100%</div><div className="stat-label">Local</div></motion.div>
        <motion.div className="stat" variants={heroItemVariants}><div className="stat-num">24/7</div><div className="stat-label">Disponible</div></motion.div>
      </motion.div>
      ...
      <section id="features">
        <div className="container">
          <Reveal>
            ...
            <h2 className="section-title">Tout ce dont tu as besoin,<br />rien de superflu</h2>
            <p className="section-desc">SkyQuest reste volontairement simple. Pas de cartes complexes ni de jargon technique — juste le ciel, ta position, et ce que tu peux vraiment voir ce soir.</p>
          </Reveal>
          <div className="features-grid">
            ...
            <Reveal className="feature-card">
              ...
              <p>Une interface épurée, pensée pour la nuit. Pas de fioritures, pas de distractions — juste toi et les étoiles.</p>
            </Reveal>
            <Reveal className="feature-card">
        ...
        <div className="container">
          <div className="privacy-grid">
            <Reveal className="privacy-visual">
              ...
              <div className="privacy-badge"><span className="dot" />On-device · Zero tracking</div>
            </Reveal>
            <Reveal className="privacy-content">
              <div className="section-label">Confidentialité</div>
              <h2 className="section-title">Tes données restent<br />tes données</h2>
              <p className="section-desc">SkyQuest ne collecte rien. Pas de comptes, pas de serveurs, pas de télémétrie. Ta position et ton journal restent sur ton appareil — point final.</p>
      ...
      <section id="access">
        <div className="container">
          <Reveal>
            ...
            <h2 className="section-title">Trois accès,<br />rien de plus</h2>
            <p className="section-desc">SkyQuest demande le strict minimum. Chaque permission a un rôle précis — et tu gardes le contrôle total.</p>
          </Reveal>
          <div className="access-grid">
            <Reveal className="access-card">
              <div className="access-icon"><svg viewBox="0 0 24 24"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" /><circle cx="12" cy="10" r="3" /></svg></div>
              <h3>Position</h3><p>Pour adapter le ciel à ton lieu exact et afficher les objets visibles depuis ta position.</p><span className="tag">À la demande</span>
            </Reveal>
            <Reveal className="access-card">
              <div className="access-icon"><svg viewBox="0 0 24 24"><path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z" /><circle cx="12" cy="13" r="4" /></svg></div>
              <h3>Caméra</h3><p>Pour le guidage 2D en réalité augmentée — superposer les constellations sur le ciel réel.</p><span className="tag">À la demande</span>
            </Reveal>
            <Reveal className="access-card">
              <div className="access-icon"><svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="10" /><path d="M12 2L12 22M2 12L22 12" /><path d="M12 2a1515 0 0 1 0 20M12 2a15 15 0 0 0 0 20" /></svg></div>
              <h3>Orientation</h3><p>Pour indiquer où tourner ton téléphone et trouver les objets dans la bonne direction.</p><span className="tag">À la demande</span>
            </Reveal>
          </div>
        </div>
      </section>
      ...
      <footer>
        <div className="container">
          ...
          <div className="footer-bottom">
            ...
            <div className="sky-state"><span className="dot" /><span className={skyStatusVisible ? "status-visible" : "status-hidden"}>{skyStatus}</span></div>
          </div>
        </div>
      </footer>
    </main>
