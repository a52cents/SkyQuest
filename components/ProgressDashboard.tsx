      ...
      <AppCard as="section">
        ...
        <motion.div className="mt-4 grid grid-cols-2 gap-2 sm:grid-cols-3" variants={containerVariants} initial="hidden" animate="show">
          {COLLECTION_CATEGORIES.map((category) => {
            ...
            return (
              <motion.div key={category.type} className={`rounded-[14px] border p-3 ${count > 0 ? "border-accent-cyan/20 bg-accent-cyan/[0.07]" : "border-white/[0.07] bg-white/[0.025]"}`} variants={itemVariants}>
      ...
      <AppCard as="section">
        ...
        <motion.div className="mt-4 grid gap-2" variants={containerVariants} initial="hidden" animate="show">
          {achievements.map((achievement) => (
            <motion.div key={achievement.id} className={`rounded-[14px] border p-3 ${achievement.unlocked ? "border-success/20 bg-success/[0.06]" : "border-white/[0.07] bg-white/[0.025]"}`} variants={itemVariants}>
